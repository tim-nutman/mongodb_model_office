    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div id="menuTarget1">
          ...
          <div class="row">
            ...
            <div class="box box-primary">
	            <div class="box-header">
	              <h3 class="box-title">Product Sub Types/Categories</h3>
	            </div>
	            <div class="box-body table-responsive">
	            	<table id="customerlist" class="table table-bordered table-striped">
                    	<thead>
                    		<tr>
                    			<th>Sub-Type ID</th>
                    		    <th>Product Sub-Type Name</th>
                    			<th>Product (Parent) Type ID / Name</th>
                    			<th>Active</th>
                    			<th>Actions</th>
                    		</tr>
                   	</thead>
                    	<tbody>
                    		<sql:query dataSource="${snapshot}" var="productSubTypes">
                    			SELECT prd_sub_type_id, parent_type_ref, product_sub_type, active FROM prod_sub_type;
                    		</sql:query>
                    		<c:forEach var="productSubType" items="${productSubTypes.rows}">
                    			<tr>
                    				<td><c:out value="${productSubType.prd_sub_type_id}" /></td>
                    				<td><c:out value="${productSubType.product_sub_type}" /></td>
                    				<td>
                    					<sql:query dataSource="${snapshot}" var="productTypes">
                    						SELECT product_type FROM prod_type WHERE prd_type_id=?;
                    						<sql:param value="${productSubType.parent_type_ref}" />
                    					</sql:query>
                    					<c:forEach var="productType" items="${productTypes.rows}">
                    						<c:out value="${productSubType.parent_type_ref}" />, <c:out value="${productType.product_type}" />
                    					</c:forEach>
                    				</td>
                    				<td><c:out value="${productSubType.active}" /></td>
                    				<td>
                    					<form action="editProductSubType" method="post">
					                		<input type="hidden" name="prod_sub_type_id" value="${productSubType.prd_sub_type_id}">
								            <button type="submit" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Edit Product Sub Type">
          ...
          <div class="row">
            <div class="col-md-12">
            		<form action="../../CreateProductSubType" method="post" role="form">
		            <div class="box box-primary">
			            <div class="box-header">
			              <h3 class="box-title">Create New Product Sub Type/Category</h3>
			            </div>
		            		<div class="box-body">
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<label for="parent_prod_ref">(Parent) Product Type</label>
										<select class="form-control" id="parent_prod_ref" name="parent_prod_ref">
											<sql:query dataSource="${snapshot}" var="productTypes">
									...
									<div class="form-group">
    										<label for="product_sub_type">Product Sub Type Name</label>
    										<input type="text" class="form-control" id="product_sub_type" name="product_sub_type" placeholder="Product Sub Type Name">
    									</div>
									<div class="form-group">
