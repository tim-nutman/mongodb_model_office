      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu tree" data-widget="tree">
	      	...
	      	<li class="treeview active"><a href="customers"><i class="fa fa-users"></i> <span>Customers</span></a></li>
											...
											<div class="form-group">
	       									...
	       									<div class="form-group">
	       										...
	       										<select class="form-control" id="cust_active" name="cust_active">
	        											<option value="1" <c:if test="${cust_details.active == 1 }">selected</c:if> >Active</option>
	        											<option value="0" <c:if test="${cust_details.active == 0 }">selected</c:if> >Dormant</option>
	        										</select>
	       									</div>
	       									<div class="form-group">
